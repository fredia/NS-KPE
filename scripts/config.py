...
def add_default_args(parser):
    ...
    feature_group.add_argument('--upper', action='store_true')
    feature_group.add_argument('--tagger', action='store_true')
    feature_group.add_argument('--pis', action='store_true')
    feature_group.add_argument('--sn', action='store_true')
    feature_group.add_argument('--topic', action='store_true')
    feature_group.add_argument('--number', type=str, default='2')
    feature_group.add_argument('--topic_num', type=int, default=30)
    feature_group.add_argument('--word_num', type=int, default=30)
    feature_group.add_argument('--alpha', type=float, default=0.5)
    feature_group.add_argument('--vae_gamma', type=float, default=0.01)
    feature_group.add_argument('--topic_emb_path', type=str, default="")
    feature_group.add_argument('--note', type=str, default="")
    feature_group.add_argument('--sampling_rate', type=float, default=0.7)
    feature_group.add_argument('--mask_rate', type=float, default=0.5)
    ...
    optim.add_argument("--learning_rate", default=2e-5, type=float,
...
def init_args_config(args):
    ...
    # Result folder
    folder_name = "%s_%s_%s_%s_%s_%s_%s_" % (args.run_mode, args.model_class, args.note, args.dataset_class,
                                             args.pretrain_model_type.split('-')[0],
                                             str(args.sampling_rate), str(args.mask_rate)) + time.strftime(
        "%m.%d_%H.%M")
